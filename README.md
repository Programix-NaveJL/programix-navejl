...
- **Lenguajes:** Java, Python, Kotlin, JavaScript *(en aprendizaje)*.
- **Frontend & Móvil:** Flutter, HTML5, CSS3.
- **Bases de Datos & Backend:** MySQL, SQL Server, Supabase.
- **Infraestructura:** Cloudflare R2, Git & GitHub.
